...
describe('App', () => {
  ...
  describe('初期表示', () => {
    it('アプリケーションが正常にレンダリングされる', () => {
      ...
      expect(screen.getByText('災害情報一覧化アプリ')).toBeInTheDocument();
    ...
    it('フッターが表示される', () => {
      ...
      expect(screen.getByText(/© 2024 災害情報一覧化アプリ/)).toBeInTheDocument();
      expect(screen.getByText(/データ提供: 国土交通省、気象庁、地理院/)).toBeInTheDocument();
    });
  });
