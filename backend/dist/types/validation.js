...
exports.validateHazardInfo = validateHazardInfo;
exports.validateShelter = validateShelter;
exports.validateDisasterEvent = validateDisasterEvent;
exports.validateWeatherAlert = validateWeatherAlert;
/**
 * バリデーションエラークラス
 */
 ...
 * ハザード情報のバリデーション
 */
function validateHazardInfo(data) {
    if (!data || typeof data !== 'object') {
 ...
 * 災害イベント情報のバリデーション
 */
function validateDisasterEvent(data) {
    if (!data || typeof data !== 'object') {
 ...
 * 気象警報情報のバリデーション
 */
function validateWeatherAlert(data) {
    if (!data || typeof data !== 'object') {
